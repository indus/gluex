...
describe('#GLUEX', function () {
    it("should glue example0", function () {
        var input = "test/example0/index.html", output = "test/example0/index_gluex.html", test = "test/example0/index_test.html";
        gluex(input, output);
    ...
    it("should glue example1", function () {
        var input = "test/example1/index.html", output = "test/example1/index_gluex.html", test = "test/example1/index_test.html";
        gluex(input, output);
        expect(fs.readFileSync(test, 'utf8')).to.equal(fs.readFileSync(output, 'utf8'));
        expect(fs.readFileSync(test, 'utf8')).to.equal(gluex(input));
    });
    it("should glue example2", function () {
        var input = "test/example2/index.html", output = "test/example2/index_gluex.html", test = "test/example2/index_test.html";
        gluex(input, output);
        expect(fs.readFileSync(test, 'utf8')).to.equal(fs.readFileSync(output, 'utf8'));
        expect(fs.readFileSync(test, 'utf8')).to.equal(gluex(input));
    });
    it("should glue example3", function () {
        var input = "test/example3/index.html", output = "test/example3/index_gluex.html", test = "test/example3/index_test.html";
